...
public class WorkshopEvent implements EventAPI {
    ...
    public WorkshopEvent(String id, String title, String description,
    ...
    private WorkshopEvent(Builder builder) {
