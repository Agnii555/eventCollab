...
public class LectureEvent implements EventAPI {
    ...
    public LectureEvent(String id, String title, String description,
    ...
    private LectureEvent(Builder builder) {
